...
function About() {
  return (
    <div className="pt-[82px] pb-3 bg-gray-100 font-serif">
        {/* Our Story */}
        <section className="pb-12 mx-auto max-w-[1200px]">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-16">
            ...
            <div className="w-full md:w-1/4 rounded-xl overflow-hidden mb-4">
              {/* Image */}
              <img src={require("./quil.png")} alt="Quilombo Café" className="w-full h-full object-cover rounded-xl" />
            </div>
            {/* Container for text */}
            <div className=" w-full  bg-[#F9F6EE] md:w-3/4">
              <div className="rounded-xl  border-4 border-[darkred] bg-white p-4">
                {/* Our Story title */}
                <h2 className="text-3xl text-lg font-serif font-bold text-darkred mb-4 text-left">Our Story</h2>
      ...
      <section style={{ backgroundColor: "#C70000" }} className="w-screen ">
        <div className="pb-12 container mx-auto max-w-[1200px] py-8">
          <section className="text-white mx-auto max-w-[1400px] rounded-xl">
            <h2 className="text-3xl text-[#FFFF] text-lg font-serif font-bold mb-4">Location and Hours</h2>
        ...
        <section className="mx-auto mt-8 max-w-[1200px]">
          <h2 className="pt-8 text-3xl  text-lg font-serif font-bold text-darkred mb-4">Get in Touch!</h2>
          {/* Social Media Links */}
          <div className="bg-white p-4 rounded-xl flex justify-between">
            ...
            <a href="tel:+12066026412" target="_blank" rel="noopener noreferrer" className="text-2xl flex items-center">
              ...
              <span className="ml-2 text-base font-semibold">(206) 602-6412</span>
            </a>
            {/* Instagram */}
            <a href="https://www.instagram.com/cafetalquilombocafe" target="_blank" rel="noopener noreferrer" className="text-2xl flex items-center">
              ...
              <span className="ml-2 text-base font-semibold">@cafetalquilombocafe</span>
            </a>
            {/* Facebook */}
            <a href="https://www.facebook.com/cafetalquilombo/" target="_blank" rel="noopener noreferrer" className="text-2xl flex items-center">
              ...
              <span className="ml-2 text-base font-semibold">Cafetal Quilombo</span>
            </a>
          </div>
        </section>
      </div>
